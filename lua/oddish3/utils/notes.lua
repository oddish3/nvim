...
vim.api.nvim_create_autocmd('FileType', {
  ...
  callback = function()
    ...
    vim.api.nvim_buf_set_keymap(0, 'n', '<leader>cn', ':lua create_notes()<CR>', { noremap = true, silent = true })
...
function! PrepareImage() abort " {{{1
  ...
  let l:dir = '/home/oddish3/Pictures/anki/'
  ...
  let l:root = !empty($APY_BASE)
        \ ? $APY_BASE
        \ : '/home/oddish3/.local/share/Anki2/oddish3/collection.media'
...
function! ViewImage() abort
  ...
  let l:root = '/home/oddish3/.local/share/Anki2/oddish3/collection.media'
