...
local function qa_pair(args, parent, old_state)
    ...
    table.insert(nodes, d(3, function(args_inner, parent_inner, old_state_inner)
...
ls.add_snippets("markdown", {
    -- Your heading snippets remain unchanged
    s("H1", fmt("# {}\n\n{}", { i(1), i(2) })),
    s("H2", fmt("## {}\n\n{}", { i(1), i(2) })),
    s("H3", fmt("### {}\n\n{}", { i(1), i(2) })),
    s("H4", fmt("#### {}\n\n{}", { i(1), i(2) })),
    ...
    -- Main Q&A snippet that starts the recursion
    s("Aq", {
        t("Q: "),
        i(1),
        t({"", "A: "}),
